...
- **Auth**: JWT (usuarios) + credencial de gateway (`X-API-Key`) con `X-Logical-Node-Id`; ownership multi-tenant en la capa de servicio (`core/authz.py`). Flujo completo en `docs/system.md`.
